$(document).ready(function () {
  ...
  posts.forEach((item) => {
    var post = `<article class="post">
                    ...
                    <a href="${item.URL}" class="button-more">Artículo Completo</a>
                </article>`;
    //console.log(post);
    $("#posts").append(post);
  });
  ...
  $("#login form").submit(function(){
    //variables utilizadas en secciones locales utilizar let
  ...
  //Si el nombre existe
  let about_parrafo = $("#welcome");
  $("#welcome").html("<b>Bienvenido " + form_name + "</b>");
